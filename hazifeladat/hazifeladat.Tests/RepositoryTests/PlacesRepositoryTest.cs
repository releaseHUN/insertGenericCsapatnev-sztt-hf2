...
public class PlacesRepositoryTest
{
    ...
    public async Task DeleteAsync_DeletesBooking_AndPersistsToFile()
    {
        ...
        var places1 = new Places {Id = 5, Type = (DAL1.Models.Enums.PlaceTypes)1 };
        var places2 = new Places {Id = 7, Type = (DAL1.Models.Enums.PlaceTypes)2 };
        var places3 = new Places { Id = 8, Type = (DAL1.Models.Enums.PlaceTypes)2 };
